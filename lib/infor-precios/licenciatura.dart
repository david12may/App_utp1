...
class StarterPage7 extends StatefulWidget {
  @override
  _StarterPageState7 createState() => _StarterPageState7();
}

class _StarterPageState7 extends State<StarterPage7>
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage('assets/lin.jpg'), fit: BoxFit.cover)),
        child: Container(
          decoration: BoxDecoration(
