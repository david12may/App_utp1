...
class StarterPage2 extends StatefulWidget {
  @override
  _StarterPageState2 createState() => _StarterPageState2();
}

class _StarterPageState2 extends State<StarterPage2>
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage('assets/IMG-3.jpg'), fit: BoxFit.cover)),
        child: Container(
          decoration: BoxDecoration(
